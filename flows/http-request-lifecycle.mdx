...
| 8 | Multi-tenancy | `MultiTenancyMiddleware` &mdash; `Volo/Abp/AspNetCore/MultiTenancy/` | `app.UseMultiTenancy()` |
...
`MultiTenancyMiddleware.InvokeAsync` (`Volo/Abp/AspNetCore/MultiTenancy/MultiTenancyMiddleware.cs`):
