...
```mermaid
flowchart LR
    Caller[[Application code]] -->|"IsGrantedAsync(\"BookStore.Books.Create\")"| Checker
    subgraph PermissionChecker
      ...
      Checker -->|ValueProviders.foreach| Mgr[PermissionValueProviderManager]
    ...
    Store[IPermissionStore<br/>(PermissionStore)] --> Cache[(IDistributedCache<br/>PermissionGrantCacheItem)]
