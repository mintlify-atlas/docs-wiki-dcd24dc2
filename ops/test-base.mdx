...
description: "AbpIntegratedTest, AbpAsyncIntegratedTest, AbpAspNetCoreIntegratedTestBase and AbpWebApplicationFactoryIntegratedTest — the four base classes every *.Tests project in abpframework/abp inherits from."
---
