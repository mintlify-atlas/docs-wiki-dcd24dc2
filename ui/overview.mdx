...
| Blazor component base + UI-service contracts | `framework/src/Volo.Abp.AspNetCore.Components/` | `AbpComponentBase`, `ServiceProviderComponentActivator`, `IUiMessageService`, `IUiNotificationService`, `IUiPageProgressService`, `IBlockUiService`, `IUserExceptionInformer`, `IAlertManager` + `AlertList`/`AlertMessage`/`AlertType` |
| Blazor shared web layer | `framework/src/Volo.Abp.AspNetCore.Components.Web/` | `AbpAuthenticationState`, `AbpComponentsClaimsCache`, `ICookieService`, `ILocalStorageService`, `IServerUrlProvider`/`DefaultServerUrlProvider`, `IAbpUtilsService`, `SimpleUiMessageService`, `AlertManager`, `UserExceptionInformer`, `ICurrentApplicationConfigurationCacheResetService` |
