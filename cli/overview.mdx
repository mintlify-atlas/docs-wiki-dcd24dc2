...
| `SwitchToLocalCommand.cs` | `switch-to-local` | Replace NuGet refs with local `<ProjectReference>` |
...
| `Bundling/` | Blazor static-asset bundler | `IBundlingService`, `BundlingService`, `IScriptBundler`, `IStyleBundler` |
...
| `Telemetry/` | Activity tracking + enrichers | `ITelemetryService`, `TelemetrySessionInfoEnricher` |
