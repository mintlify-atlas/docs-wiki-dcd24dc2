...
| `modules/` | 19 pre-built application modules (Identity, Account, OpenIddict, IdentityServer, PermissionManagement, SettingManagement, FeatureManagement, TenantManagement, AuditLogging, BackgroundJobs, BlobStoring.Database, CmsKit, Blogging, Docs, Users, VirtualFileExplorer, BasicTheme, ClientSimulation). | [Application modules](/modules/overview) |
...
<CardGroup cols={2}>
  ...
  <Card title="Application Modules" icon="puzzle-piece" href="/modules/overview">
    19 plug-in modules — Identity, Account, OpenIddict, CmsKit, Docs, Blogging and more.
  </Card>
