...
| `modules/` | dir | 19 application modules (Identity, OpenIddict, CmsKit, …) |
...
| `test/` | dir | Root-level cross-cutting tests (e.g. shared integration scaffolding) |
...
19 official application modules (`ls modules`):
...
| `cms-kit/` | Blogs, pages, comments, tags, polls | `CmsKitDomainModule`, `CmsKitProDomainModule` |
...
| Path | Purpose |
| --- | --- |
| `test/` | Cross-module integration test scaffolding shared by multiple solutions |
